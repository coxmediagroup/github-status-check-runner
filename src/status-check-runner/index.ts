import { StatusCheckState } from 'types';
...
/**
 * Creates, or updates, a GitHub status-check, labeled `context`, sets the
 * status of it to 'pending'
 *
