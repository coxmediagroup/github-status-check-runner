...
import envArgs from './env-vars';

export const topArgKeys: ghsc.NormalizedArgsKeys[] = ['git', 'github', 'statusChecks', 'other'];
...
const argsCoalesced = coalesceArgs(baseArgs(), envArgs(), cliArgs());
